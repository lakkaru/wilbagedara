<div id="container" class="row well ">  
    <div class="col-lg-12">
        <legend class="lead">සාමාජික මුදල් ලැබීම් </legend>
    </div>
    <div class="col-lg-3">
        <form method="post" id="paymentsForm" class="form-horizontal validateForm" action="<?php echo URL; ?>awamangala/createPayments/membershippayments" >         
    ...
    <div class="col-lg-9">
        <div class="row well">
            <div class="container-fluid  form-inline ">
                <div class="row">
                    <button id="addToDb" onclick="createPaymentsArray()" class="btn btn-info center-block" style="margin-bottom: 20px">නව සාමාජික මුදල් ගෙවීම් තොරතුරු පද්ධතියට ඇතුලු කරන්න</button>
                </div>
                <div class="row">
                    <div class="col-lg-12">
