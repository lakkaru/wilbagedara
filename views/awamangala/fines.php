<div id="container" class="row well ">  
    <div class="col-lg-12">
        <legend class="lead">පසු ගිය හිඟ මුදල් </legend>
    </div>
    <form method="post" id="searchFinesForm" class="form-horizontal container-fluid" action="<?php echo URL; ?>awamangala/searchFines" >  
...
<!--            <div class=" col-lg-1">
            ...
            <div class="row col-lg-10" style="text-align: left">
                <button type="button" id="searchFines" class="btn btn-success">සොයන්න&nbsp;<span class="glyphicon glyphicon-search"></span></button>
    ...
    <div class="col-lg-8">
        <div class="row well">
            <div class=" panel">
                <div class="row">
                    <div class="col-lg-12">
                        <table id="finesTable" class="table table-striped table-bordered " cellspacing="0" width="100%" role="grid">
                            <thead>
                                <tr role="row">
...
<!--                            <tfoot>
                           ...
                           <tbody><?php
                                foreach ($this->finesList as $key => $value) {
                                    echo '<tr>';
