<div id="container" class="row well ">  
    <div class="col-lg-12">
        <legend class="lead">අතිරේක ආධාර හිඟ ඇතුලත් කිරීම් </legend>
    </div>
    <div class="col-lg-3">
        <form method="post" id="extraFundsForm" class="form-horizontal validateForm" action="<?php echo URL; ?>awamangala/createExtraFundsDue" >         
...
<!--                <div class="form-group row">
                ...
                <div class=" col-lg-6 frp0">
                    <input type="button" id="addItem"  class=" btn form-control btn-primary" onclick="addExtraFundsDueTableItem()" value="ඊලඟ">
                </div>
            </div>
        </form>
    </div>
    ...
    <div class="col-lg-9">
        <div class="row well">
            <div class="container-fluid  form-inline ">
                <div class="row">
                    <button id="addToDb" onclick="createExtraFundsDueArray()" class="btn btn-info center-block" style="margin-bottom: 20px">නව අතිරේක ආධාර හිඟ මුදල් තොරතුරු පද්ධතියට ඇතුලු කරන්න</button>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <table id="extraFunds" class="table table-striped table-bordered " cellspacing="0" width="100%" role="grid">
                            <thead>
                                <tr role="row">
